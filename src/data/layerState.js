...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'flock-cameras', token: 'k', disposition: 'enabled-only' }),
  Object.freeze({ id: 'gaming-data', token: 'y', disposition: 'enabled-only' }),
  Object.freeze({ id: 'global-news-reports', token: 'j', disposition: 'enabled-only' }),
  Object.freeze({ id: 'law-enforcement-transmissions', token: 'p', disposition: 'enabled-only' }),
  Object.freeze({ id: 'live-events', token: 'n', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'weather-alerts', token: 'z', disposition: 'enabled-only' }),
